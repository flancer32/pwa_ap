...
git clone git@github.com:flancer32/mod_ap_user.git "${DIR_OWN}/@flancer32/mod_ap_user"
...
rm -fr "${DIR_NODE}/@flancer32/mod_ap_user" && ln -s "${DIR_OWN}/@flancer32/mod_ap_user" "${DIR_NODE}/@flancer32/mod_ap_user"
