 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_DataSource_Profile
 */
class Fl32_Ap_Front_Area_Pub_DataSource_Profile {
    ...
    constructor(spec) {
         ...
         * @return {Promise<Fl32_Ap_Front_Area_Pub_Dto_Profile>}
         */
...
Fl32_Ap_Front_Area_Pub_DataSource_Profile.TYPE = 'pub/profile';

// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Pub_DataSource_Profile;
