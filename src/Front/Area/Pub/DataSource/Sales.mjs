 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_DataSource_Sales
 */
class Fl32_Ap_Front_Area_Pub_DataSource_Sales {
...
Fl32_Ap_Front_Area_Pub_DataSource_Sales.TYPE = 'pub/sales';

// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Pub_DataSource_Sales;
