 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_Route_Home
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Pub_Route_Home';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Ap_Front_Area_Pub_Route_Home
 * @returns {Fl32_Ap_Front_Area_Pub_Route_Home.vueCompTmpl}
 */
