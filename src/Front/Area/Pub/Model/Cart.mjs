 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_Model_Cart
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Area_Pub_Model_Cart {
    ...
    constructor(spec) {
         ...
         *
         * @param {Fl32_Ap_Front_Area_Pub_Dto_Cart} data
         */
        ...
        container
            .get('Fl32_Ap_Front_Area_Pub_Dto_Cart$$')
            .then((dto) => {
                this.setData(dto);
                this.idbGet();
            });
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Pub_Model_Cart;
