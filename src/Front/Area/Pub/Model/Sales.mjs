 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_Model_Sales
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Area_Pub_Model_Sales {
    ...
    constructor(spec) {
         ...
         *
         * @return {Object<number, Fl32_Ap_Front_Area_Pub_Dto_Sale>}
         */
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Pub_Model_Sales;
