 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_Widget_Product_Card
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Pub_Widget_Product_Card';
 ...
 *
 * @memberOf Fl32_Ap_Front_Area_Pub_Widget_Product_Card
 * @returns {Fl32_Ap_Front_Area_Pub_Widget_Product_Card.vueCompTmpl}
 */
function Factory(spec) {
    // EXTRACT DEPS
    /** @type {Fl32_Ap_Front_Area_Pub_Widget_Product_Card_Unit.vueCompTmpl} */
    const unit = spec['Fl32_Ap_Front_Area_Pub_Widget_Product_Card_Unit$']; // vue comp tmpl
