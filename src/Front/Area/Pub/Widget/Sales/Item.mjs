 ...
 *
 * @namespace Fl32_Ap_Front_Area_Pub_Widget_Sales_Item
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Pub_Widget_Sales_Item';
 ...
 *
 * @memberOf Fl32_Ap_Front_Area_Pub_Widget_Sales_Item
 * @returns {Fl32_Ap_Front_Area_Pub_Widget_Sales_Item.vueCompTmpl}
 */
...
`;
    ...
    return {
        ...
        props: {
            /** @type {Fl32_Ap_Front_Area_Pub_Dto_Sale} */
            sale: null,
        },
        computed: {
            amount() {
