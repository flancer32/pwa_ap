 ...
 *
 * @namespace Fl32_Ap_Front_Area_Shared_Idb
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Shared_Idb';
const IDB_NAME = NS;
const IDB_VERSION = 1;

// MODULE'S CLASSES
class Fl32_Ap_Front_Area_Shared_Idb {
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Shared_Idb;
