 ...
 *
 * @namespace Fl32_Ap_Front_Area_Shared_Model_Catalog
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Area_Shared_Model_Catalog {
    ...
    constructor(spec) {
         ...
         *
         * @return {Object<number, Fl32_Ap_Front_Area_Shared_Dto_Product_Card>}
         */
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Area_Shared_Model_Catalog;
