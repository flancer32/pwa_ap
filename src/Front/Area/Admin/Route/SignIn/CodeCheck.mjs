 ...
 *
 * @namespace Fl32_Ap_Front_Area_Admin_Route_SignIn_CodeCheck
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Admin_Route_SignIn_CodeCheck';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Ap_Front_Area_Admin_Route_SignIn_CodeCheck
 * @returns {Fl32_Ap_Front_Area_Admin_Route_SignIn_CodeCheck.vueCompTmpl}
 */
