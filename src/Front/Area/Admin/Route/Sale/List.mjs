 ...
 *
 * @namespace Fl32_Ap_Front_Area_Admin_Route_Sale_List
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Admin_Route_Sale_List';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Ap_Front_Area_Admin_Route_Sale_List
 * @returns {Fl32_Ap_Front_Area_Admin_Route_Sale_List.vueCompTmpl}
 */
