 ...
 *
 * @namespace Fl32_Ap_Front_Area_Admin_Widget_Sale_List_Item
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Admin_Widget_Sale_List_Item';
const EVT_EDIT = 'edit';
 ...
 *
 * @memberOf Fl32_Ap_Front_Area_Admin_Widget_Sale_List_Item
 * @returns {Fl32_Ap_Front_Area_Admin_Widget_Sale_List_Item.vueCompTmpl}
 */
...
`;
    ...
    return {
        ...
        props: {
            /** @type {Fl32_Ap_Front_Area_Admin_Dto_Sale} */
            sale: null,
        },
        computed: {
            amount() {
