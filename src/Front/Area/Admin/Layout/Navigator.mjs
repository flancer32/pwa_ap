 ...
 *
 * @namespace Fl32_Ap_Front_Area_Admin_Layout_Navigator
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Admin_Layout_Navigator';
 ...
 *
 * @memberOf Fl32_Ap_Front_Area_Admin_Layout_Navigator
 * @returns {Fl32_Ap_Front_Area_Admin_Layout_Navigator.vueCompTmpl}
 */
