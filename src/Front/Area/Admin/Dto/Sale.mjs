 ...
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Area_Admin_Dto_Sale';

// MODULE'S CLASSES
class Fl32_Ap_Front_Area_Admin_Dto_Sale {
    /** @type {Date} */
    dateCreated;
    /** @type {Date} */
    dateReceiving;
    /** @type {number} */
    id;
    /** @type {Object<number, Fl32_Ap_Front_Area_Admin_Dto_Sale_Item>} */
    items;
    /** @type {string} */
    state;
    /** @type {Fl32_Ap_Front_Area_Shared_Dto_Amount} */
    totals;
    /** @type {number} */
    userId;
}
...
// attributes names
Fl32_Ap_Front_Area_Admin_Dto_Sale.DATE_CREATED = 'dateCreated';
Fl32_Ap_Front_Area_Admin_Dto_Sale.DATE_RECEIVING = 'dateReceiving';
Fl32_Ap_Front_Area_Admin_Dto_Sale.ID = 'id';
Fl32_Ap_Front_Area_Admin_Dto_Sale.ITEMS = 'items';
Fl32_Ap_Front_Area_Admin_Dto_Sale.STATE = 'state';
Fl32_Ap_Front_Area_Admin_Dto_Sale.TOTALS = 'totals';
Fl32_Ap_Front_Area_Admin_Dto_Sale.USER_ID = 'userId';

/**
 * Factory to create new DTOs.
 * @memberOf Fl32_Ap_Front_Area_Admin_Dto_Sale
 */
class Factory {
    constructor(spec) {
        // EXTRACT DEPS
        ...
        this.create = function (data = null) {
            const result = new Fl32_Ap_Front_Area_Admin_Dto_Sale();
            ...
            if (typeof data?.items === 'object') {
                for (const one of Object.values(data.items)) {
                    /** @type {Fl32_Ap_Front_Area_Admin_Dto_Sale_Item} */
...
Object.freeze(Fl32_Ap_Front_Area_Admin_Dto_Sale);
Object.defineProperty(Factory, 'name', {value: `${NS}.${Factory.name}`});

export {
    Fl32_Ap_Front_Area_Admin_Dto_Sale as default,
    Factory
} ;
