 ...
 *
 * @namespace Fl32_Ap_Front_Realm_Admin_Model_Sales
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Realm_Admin_Model_Sales {
    ...
    constructor(spec) {
        ...
        /** @type {Fl32_Ap_Front_Realm_Admin_Dto_Sale.Factory} */
        const fSale = spec['Fl32_Ap_Front_Realm_Admin_Dto_Sale#Factory$']; // instance singleton
        /** @type {Fl32_Ap_Front_Realm_Admin_Dto_Sale_Item.Factory} */
        const fSaleItem = spec['Fl32_Ap_Front_Realm_Admin_Dto_Sale_Item#Factory$']; // instance singleton

        // DEFINE WORKING VARS
        /** @type {Object<number, Fl32_Ap_Front_Realm_Admin_Dto_Sale>} */
         ...
         *
         * @return {Object<number, Fl32_Ap_Front_Realm_Admin_Dto_Sale>}
         */
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Realm_Admin_Model_Sales;
