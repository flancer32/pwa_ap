 ...
 *
 * @namespace Fl32_Ap_Front_Realm_Admin_Layout_Base
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Realm_Admin_Layout_Base';
 ...
 *
 * @memberOf Fl32_Ap_Front_Realm_Admin_Layout_Base
 * @returns {Fl32_Ap_Front_Realm_Admin_Layout_Base.vueCompTmpl}
 */
