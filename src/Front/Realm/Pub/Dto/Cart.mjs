...
// attributes names
Fl32_Ap_Front_Realm_Pub_Dto_Cart.ITEMS = 'items';
Fl32_Ap_Front_Realm_Pub_Dto_Cart.TOTALS = 'totals';

/**
 * Factory to create new DTOs.
 * @memberOf Fl32_Ap_Front_Realm_Pub_Dto_Cart
 */
class Factory {
    constructor(spec) {
        // EXTRACT DEPS
        ...
        this.create = function () {
            const result = new Fl32_Ap_Front_Realm_Pub_Dto_Cart();
            result.items = {};
...
Object.freeze(Fl32_Ap_Front_Realm_Pub_Dto_Cart);
Object.defineProperty(Factory, 'name', {value: `${NS}.${Factory.name}`});

export {
    Fl32_Ap_Front_Realm_Pub_Dto_Cart as default,
    Factory
} ;
