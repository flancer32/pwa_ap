 ...
 *
 * @namespace Fl32_Ap_Front_Realm_Pub_Model_Profile
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Realm_Pub_Model_Profile {
    ...
    constructor(spec) {
        ...
        /** @type {Fl32_Ap_Front_Realm_Pub_DataSource_Profile} */
        const ds = spec['Fl32_Ap_Front_Realm_Pub_DataSource_Profile$']; // instance singleton
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Realm_Pub_Model_Profile;
