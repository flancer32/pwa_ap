 ...
 *
 * @namespace Fl32_Ap_Front_Realm_Pub_Route_Cfg
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Realm_Pub_Route_Cfg';
const LANG_LV = 'lv';
const LANG_RU = 'ru';
 ...
 *
 * @memberOf Fl32_Ap_Front_Realm_Pub_Route_Cfg
 * @returns {Fl32_Ap_Front_Realm_Pub_Route_Cfg.vueCompTmpl}
 */
