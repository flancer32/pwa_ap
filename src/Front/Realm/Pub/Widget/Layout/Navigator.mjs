 ...
 *
 * @namespace Fl32_Ap_Front_Realm_Pub_Widget_Layout_Navigator
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Realm_Pub_Widget_Layout_Navigator';
 ...
 *
 * @memberOf Fl32_Ap_Front_Realm_Pub_Widget_Layout_Navigator
 * @returns {Fl32_Ap_Front_Realm_Pub_Widget_Layout_Navigator.vueCompTmpl}
 */
