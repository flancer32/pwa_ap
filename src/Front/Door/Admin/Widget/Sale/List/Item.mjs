 ...
 *
 * @namespace Fl32_Ap_Front_Door_Admin_Widget_Sale_List_Item
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Admin_Widget_Sale_List_Item';
const EVT_EDIT = 'edit';
 ...
 * @returns {Fl32_Ap_Front_Door_Admin_Widget_Sale_List_Item.vueCompTmpl}
 */
