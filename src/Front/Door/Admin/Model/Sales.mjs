 ...
 *
 * @namespace Fl32_Ap_Front_Door_Admin_Model_Sales
 */

// MODULE'S CLASSES
class Fl32_Ap_Front_Door_Admin_Model_Sales {
    ...
    constructor(spec) {
        ...
        /** @type {Fl32_Ap_Front_Door_Admin_Dto_Sale.Factory} */
         ...
         *
         * @return {Object<number, Fl32_Ap_Front_Door_Admin_Dto_Sale>}
         */
...
// MODULE'S EXPORT
export default Fl32_Ap_Front_Door_Admin_Model_Sales;
