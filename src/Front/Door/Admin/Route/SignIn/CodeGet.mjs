 ...
 *
 * @namespace Fl32_Ap_Front_Door_Admin_Route_SignIn_CodeGet
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Admin_Route_SignIn_CodeGet';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Ap_Front_Door_Admin_Route_SignIn_CodeGet
 * @returns {Fl32_Ap_Front_Door_Admin_Route_SignIn_CodeGet.vueCompTmpl}
 */
