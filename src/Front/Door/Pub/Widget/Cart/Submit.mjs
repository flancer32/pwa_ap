 ...
 *
 * @namespace Fl32_Ap_Front_Door_Pub_Widget_Cart_Submit
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Pub_Widget_Cart_Submit';
 ...
 * @returns {Fl32_Ap_Front_Door_Pub_Widget_Cart_Submit.vueCompTmpl}
 */
