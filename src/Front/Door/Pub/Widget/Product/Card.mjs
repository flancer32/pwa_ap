 ...
 *
 * @namespace Fl32_Ap_Front_Door_Pub_Widget_Product_Card
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Pub_Widget_Product_Card';
 ...
 * @returns {Fl32_Ap_Front_Door_Pub_Widget_Product_Card.vueCompTmpl}
 */
