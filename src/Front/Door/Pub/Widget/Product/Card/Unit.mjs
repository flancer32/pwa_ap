 ...
 *
 * @namespace Fl32_Ap_Front_Door_Pub_Widget_Product_Card_Unit
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Pub_Widget_Product_Card_Unit';
 ...
 * @returns {Fl32_Ap_Front_Door_Pub_Widget_Product_Card_Unit.vueCompTmpl}
 */
