 ...
 *
 * @namespace Fl32_Ap_Front_Door_Pub_DataSource_Cart
 */
class Fl32_Ap_Front_Door_Pub_DataSource_Cart {
    ...
    constructor(spec) {
        ...
        // DEFINE WORKING VARS
        const TYPE = Fl32_Ap_Front_Door_Pub_DataSource_Cart.TYPE;
...
Fl32_Ap_Front_Door_Pub_DataSource_Cart.TYPE = 'pub/cart';

// MODULE'S EXPORT
export default Fl32_Ap_Front_Door_Pub_DataSource_Cart;
