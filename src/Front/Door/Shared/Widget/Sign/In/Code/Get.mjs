 ...
 *
 * @namespace Fl32_Ap_Front_Door_Shared_Widget_Sign_In_Code_Get
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Shared_Widget_Sign_In_Code_Get';
const TIMEOUT = 3000;
 ...
 * @returns {Fl32_Ap_Front_Door_Shared_Widget_Sign_In_Code_Get.vueCompTmpl}
 */
