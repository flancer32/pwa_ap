 ...
 *
 * @namespace Fl32_Ap_Front_Door_Shared_Widget_Scroller_Vertical
 */
// MODULE'S VARS
const NS = 'Fl32_Ap_Front_Door_Shared_Widget_Scroller_Vertical';
 ...
 *
 * @memberOf Fl32_Ap_Front_Door_Shared_Widget_Scroller_Vertical
 * @returns {Fl32_Ap_Front_Door_Shared_Widget_Scroller_Vertical.vueCompTmpl}
 */
function Factory(spec) {
    /** @type {typeof Fl32_Ap_Front_Shared_On_Touch} */
    const OnTouch = spec['Fl32_Ap_Front_Shared_On_Touch#'];
    ...
    return {
        ...
        mounted() {
            ...
            /** @type {Fl32_Ap_Front_Shared_On_Touch} */
